namespace Schema.NET
{
    ...
    public partial class ServiceChannel : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "availableLanguage", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "processingTime", Order = 206)]
        ...
        /// </summary>
        [DataMember(Name = "providesService", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "serviceLocation", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "servicePhone", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "servicePostalAddress", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "serviceSmsNumber", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "serviceUrl", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
