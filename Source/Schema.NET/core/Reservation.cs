namespace Schema.NET
{
    ...
    public partial class Reservation : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "bookingTime", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "broker", Order = 205)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "modifiedTime", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "programMembershipUsed", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "provider", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "reservationFor", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "reservationId", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "reservationStatus", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "reservedTicket", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "totalPrice", Order = 214)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "underName", Order = 215)]
        [JsonConverter(typeof(ValuesConverter))]
        public Values<Person, Organization>? UnderName { get; set; }
    }
}
