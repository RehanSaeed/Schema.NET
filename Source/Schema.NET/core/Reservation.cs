namespace Schema.NET
{
    ...
    public partial class Reservation : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "bookingTime", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "modifiedTime", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "programMembershipUsed", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "reservationFor", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "reservationId", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "reservationStatus", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "reservedTicket", Order = 214)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "totalPrice", Order = 215)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "underName", Order = 216)]
        [JsonConverter(typeof(ValuesConverter))]
