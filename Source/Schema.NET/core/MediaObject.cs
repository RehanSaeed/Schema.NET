namespace Schema.NET
{
    ...
    public partial class MediaObject : CreativeWork
    {
        ...
        /// </summary>
        [DataMember(Name = "associatedArticle", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "bitrate", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "contentSize", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "contentUrl", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "embedUrl", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "encodesCreativeWork", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// mp3, mpeg4, etc.
        /// </summary>
        [DataMember(Name = "encodingFormat", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "expires", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
