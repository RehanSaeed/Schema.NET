namespace Schema.NET
{
    ...
    public partial class MediaObject : CreativeWork
    {
        ...
        /// </summary>
        [DataMember(Name = "associatedArticle", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "bitrate", Order = 205)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "contentSize", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "contentUrl", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "embedUrl", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "encodesCreativeWork", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// mp3, mpeg4, etc.
        /// </summary>
        [DataMember(Name = "encodingFormat", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "expires", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "playerType", Order = 214)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "productionCompany", Order = 215)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "regionsAllowed", Order = 216)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "requiresSubscription", Order = 217)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "uploadDate", Order = 218)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "width", Order = 219)]
        [JsonConverter(typeof(ValuesConverter))]
