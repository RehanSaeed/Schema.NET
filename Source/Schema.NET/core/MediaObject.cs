...
namespace Schema.NET
{
    ...
    public partial class MediaObject : CreativeWork
    {
        ...
        public class Heightint : IHeight<int>
        {
            object IWrapper.Data { get { return Data; } set { Data = (int) value; } }
            public virtual int Data { get; set; }
            public Heightint () { }
            public Heightint (int data) { Data = data; }
            public static implicit operator Heightint (int data) { return new Heightint (data); }
        }
        ...
        public class Widthint : IWidth<int>
        {
            object IWrapper.Data { get { return Data; } set { Data = (int) value; } }
            public virtual int Data { get; set; }
            public Widthint () { }
            public Widthint (int data) { Data = data; }
            public static implicit operator Widthint (int data) { return new Widthint (data); }
        }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public Values<IHeight>? Height { get; set; } //string, QuantitativeValue, int
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public Values<IWidth>? Width { get; set; } //string, QuantitativeValue, int
    }
}
