namespace Schema.NET
{
    ...
    public partial class Ticket : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "dateIssued", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "issuedBy", Order = 205)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "priceCurrency", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "ticketedSeat", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "ticketNumber", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "ticketToken", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "totalPrice", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "underName", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
