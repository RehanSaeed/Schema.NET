namespace Schema.NET
{
    ...
    /// </summary>
    [DataContract]
    public partial class SuperficialAnatomy : MedicalEntity, ISuperficialAnatomy, IEquatable<SuperficialAnatomy>
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public bool Equals(SuperficialAnatomy other)
        {
            if (other is null)
            {
                return false;
            ...
            return this.Type == other.Type &&
                ...
                this.RelatedAnatomy == other.RelatedAnatomy &&
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => this.Equals(obj as SuperficialAnatomy);

        /// <inheritdoc/>
        public override int GetHashCode() => HashCode.Of(this.Type)
            .And(this.AssociatedPathophysiology)
            .And(this.RelatedAnatomy)
