namespace Schema.NET
{
    ...
    public partial class WebPage : CreativeWork
    {
        ...
        /// </summary>
        [DataMember(Name = "breadcrumb", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "lastReviewed", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "mainContentOfPage", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "primaryImageOfPage", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "relatedLink", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "reviewedBy", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "significantLink", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "specialty", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
