...
namespace Schema.NET
{
    ...
    public partial class JobPosting : Intangible
    {
        ...
        public interface IEstimatedSalary : IWrapper { }
        public interface IEstimatedSalary<T> : IEstimatedSalary { new T Data { get; set; } }
        public class EstimatedSalaryMonetaryAmount : IEstimatedSalary<MonetaryAmount>
        {
            object IWrapper.Data { get { return Data; } set { Data = (MonetaryAmount) value; } }
            public virtual MonetaryAmount Data { get; set; }
            public EstimatedSalaryMonetaryAmount () { }
            public EstimatedSalaryMonetaryAmount (MonetaryAmount data) { Data = data; }
            public static implicit operator EstimatedSalaryMonetaryAmount (MonetaryAmount data) { return new EstimatedSalaryMonetaryAmount (data); }
        }

        public class EstimatedSalarydecimal : IEstimatedSalary<decimal>
        {
            object IWrapper.Data { get { return Data; } set { Data = (decimal) value; } }
            public virtual decimal Data { get; set; }
            public EstimatedSalarydecimal () { }
            public EstimatedSalarydecimal (decimal data) { Data = data; }
            public static implicit operator EstimatedSalarydecimal (decimal data) { return new EstimatedSalarydecimal (data); }
        }

        public class EstimatedSalaryPriceSpecification : IEstimatedSalary<PriceSpecification>
        {
            object IWrapper.Data { get { return Data; } set { Data = (PriceSpecification) value; } }
            public virtual PriceSpecification Data { get; set; }
            public EstimatedSalaryPriceSpecification () { }
            public EstimatedSalaryPriceSpecification (PriceSpecification data) { Data = data; }
            public static implicit operator EstimatedSalaryPriceSpecification (PriceSpecification data) { return new EstimatedSalaryPriceSpecification (data); }
        }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public Values<IEstimatedSalary>? EstimatedSalary { get; set; } //MonetaryAmount, decimal?, PriceSpecification
