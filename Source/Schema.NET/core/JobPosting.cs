namespace Schema.NET
{
    ...
    public partial class JobPosting : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "baseSalary", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "datePosted", Order = 205)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "employmentType", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "hiringOrganization", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "incentiveCompensation", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "industry", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "jobBenefits", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "jobLocation", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "occupationalCategory", Order = 214)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "qualifications", Order = 215)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "responsibilities", Order = 216)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "salaryCurrency", Order = 217)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "skills", Order = 218)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "specialCommitments", Order = 219)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "title", Order = 220)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "validThrough", Order = 221)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "workHours", Order = 222)]
        [JsonConverter(typeof(ValuesConverter))]
