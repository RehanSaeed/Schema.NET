namespace Schema.NET
{
    ...
    public partial class BroadcastService : Service
    {
        ...
        /// </summary>
        [DataMember(Name = "broadcastAffiliateOf", Order = 305)]
        ...
        /// </summary>
        [DataMember(Name = "broadcastDisplayName", Order = 306)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "broadcaster", Order = 307)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "broadcastTimezone", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "parentService", Order = 309)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "videoFormat", Order = 310)]
        [JsonConverter(typeof(ValuesConverter))]
