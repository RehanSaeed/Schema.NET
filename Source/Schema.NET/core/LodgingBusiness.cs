namespace Schema.NET
{
    ...
    public partial class LodgingBusiness : LocalBusiness
    {
        ...
        /// </summary>
        [DataMember(Name = "amenityFeature", Order = 305)]
        ...
        /// </summary>
        [DataMember(Name = "audience", Order = 306)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "checkinTime", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "checkoutTime", Order = 309)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "petsAllowed", Order = 310)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "starRating", Order = 311)]
        [JsonConverter(typeof(ValuesConverter))]
