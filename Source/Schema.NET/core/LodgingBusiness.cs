namespace Schema.NET
{
    ...
    public partial class LodgingBusiness : LocalBusiness
    {
        ...
        /// </summary>
        [DataMember(Name = "amenityFeature", Order = 304)]
        [JsonConverter(typeof(ValuesConverter))]
        public Values<LocationFeatureSpecification>? AmenityFeature { get; set; }

        /// <summary>
        /// An intended audience, i.e. a group for whom something was created.
        /// </summary>
        [DataMember(Name = "audience", Order = 305)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "checkinTime", Order = 307)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "checkoutTime", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "starRating", Order = 310)]
        [JsonConverter(typeof(ValuesConverter))]
