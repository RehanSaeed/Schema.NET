namespace Schema.NET
{
    ...
    public partial interface IQuestion : ICreativeWork
    {
        ...
        /// </summary>
        OneOrMany<IAnswer>? AcceptedAnswer { get; set; }
        ...
        /// </summary>
        OneOrMany<IAnswer>? SuggestedAnswer { get; set; }
    ...
    public partial class Question : CreativeWork, IQuestion
    {
        ...
        public OneOrMany<IAnswer>? AcceptedAnswer { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public OneOrMany<IAnswer>? SuggestedAnswer { get; set; }
