namespace Schema.NET
{
    ...
    public partial class VideoObject : MediaObject
    {
        ...
        /// </summary>
        [DataMember(Name = "caption", Order = 305)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "thumbnail", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "transcript", Order = 309)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "videoFrameSize", Order = 310)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "videoQuality", Order = 311)]
        [JsonConverter(typeof(ValuesConverter))]
