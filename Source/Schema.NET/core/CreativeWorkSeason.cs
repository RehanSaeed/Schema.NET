...
namespace Schema.NET
{
    ...
    {
        public interface ISeasonNumber : IWrapper { }
        public interface ISeasonNumber<T> : ISeasonNumber { new T Data { get; set; } }
        public class SeasonNumberint : ISeasonNumber<int>
        {
            object IWrapper.Data { get { return Data; } set { Data = (int) value; } }
            public virtual int Data { get; set; }
            public SeasonNumberint () { }
            public SeasonNumberint (int data) { Data = data; }
            public static implicit operator SeasonNumberint (int data) { return new SeasonNumberint (data); }
        }

        public class SeasonNumberstring : ISeasonNumber<string>
        {
            object IWrapper.Data { get { return Data; } set { Data = (string) value; } }
            public virtual string Data { get; set; }
            public SeasonNumberstring () { }
            public SeasonNumberstring (string data) { Data = data; }
            public static implicit operator SeasonNumberstring (string data) { return new SeasonNumberstring (data); }
        }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public Values<ISeasonNumber>? SeasonNumber { get; set; } //int?, string
