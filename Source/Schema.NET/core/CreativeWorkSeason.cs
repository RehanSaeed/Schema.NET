namespace Schema.NET
{
    ...
    public partial class CreativeWorkSeason : CreativeWork
    {
        ...
        /// </summary>
        [DataMember(Name = "actor", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "director", Order = 205)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "episode", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "numberOfEpisodes", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "partOfSeries", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "productionCompany", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "seasonNumber", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "startDate", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "endDate", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
