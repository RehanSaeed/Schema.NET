namespace Schema.NET
{
    ...
    public partial class ItemList : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "itemListElement", Order = 205)]
        [JsonConverter(typeof(ValuesConverter))]
        public Values<ListItem, Thing, string>? ItemListElement { get; set; }

        /// <summary>
        /// Type of ordering (e.g. Ascending, Descending, Unordered).
        /// </summary>
        [DataMember(Name = "itemListOrder", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        public Values<string, ItemListOrderType?>? ItemListOrder { get; set; }

        /// <summary>
        /// The number of items in an ItemList. Note that some descriptions might not fully describe all items in a list (e.g., multi-page pagination); in such cases, the numberOfItems would be for the entire list.
        /// </summary>
        [DataMember(Name = "numberOfItems", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
