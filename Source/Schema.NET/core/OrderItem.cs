namespace Schema.NET
{
    ...
    public partial class OrderItem : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "orderDelivery", Order = 205)]
        ...
        /// The item ordered.
        /// </summary>
        [DataMember(Name = "orderedItem", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "orderItemNumber", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "orderItemStatus", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "orderQuantity", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
