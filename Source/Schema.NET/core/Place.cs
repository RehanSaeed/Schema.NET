namespace Schema.NET
{
    ...
    public partial interface IPlace : IThing
    {
        ...
        /// </summary>
        OneOrMany<ILocationFeatureSpecification, LocationFeatureSpecification> AmenityFeature { get; set; }
        ...
        /// </summary>
        OneOrMany<IPlace, Place> ContainedInPlace { get; set; }

        /// <summary>
        /// The basic containment relation between a place and another that it contains.
        /// </summary>
        OneOrMany<IPlace, Place> ContainsPlace { get; set; }
        ...
        /// </summary>
        OneOrMany<IOpeningHoursSpecification, OpeningHoursSpecification> OpeningHoursSpecification { get; set; }
        ...
        /// </summary>
        OneOrMany<IOpeningHoursSpecification, OpeningHoursSpecification> SpecialOpeningHoursSpecification { get; set; }
    ...
    public partial class Place : Thing, IPlace
    {
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> ContainedInPlace { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> ContainsPlace { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> GeoContains { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> GeoCoveredBy { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> GeoCovers { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> GeoCrosses { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> GeoDisjoint { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> GeoEquals { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> GeoIntersects { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> GeoOverlaps { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> GeoTouches { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPlace, Place> GeoWithin { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IOpeningHoursSpecification, OpeningHoursSpecification> OpeningHoursSpecification { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IOpeningHoursSpecification, OpeningHoursSpecification> SpecialOpeningHoursSpecification { get; set; }
