namespace Schema.NET
{
    ...
    public partial class Place : Thing
    {
        ...
        /// </summary>
        [DataMember(Name = "amenityFeature", Order = 107)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "branchCode", Order = 108)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "containedInPlace", Order = 109)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "containsPlace", Order = 110)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "event", Order = 111)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// The fax number.
        /// </summary>
        [DataMember(Name = "faxNumber", Order = 112)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "globalLocationNumber", Order = 114)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "hasMap", Order = 115)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "isicV4", Order = 116)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// An associated logo.
        /// </summary>
        [DataMember(Name = "logo", Order = 117)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "maximumAttendeeCapacity", Order = 118)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "openingHoursSpecification", Order = 119)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "photo", Order = 120)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "review", Order = 121)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "smokingAllowed", Order = 122)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "specialOpeningHoursSpecification", Order = 123)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "telephone", Order = 124)]
        [JsonConverter(typeof(ValuesConverter))]
