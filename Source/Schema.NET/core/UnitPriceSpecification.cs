namespace Schema.NET
{
    ...
    public partial class UnitPriceSpecification : PriceSpecification
    {
        ...
        /// </summary>
        [DataMember(Name = "billingIncrement", Order = 405)]
        ...
        /// </summary>
        [DataMember(Name = "priceType", Order = 406)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "referenceQuantity", Order = 407)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "unitCode", Order = 408)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "unitText", Order = 409)]
        [JsonConverter(typeof(ValuesConverter))]
