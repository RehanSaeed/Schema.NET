namespace Schema.NET
{
    ...
    public partial class UnitPriceSpecification : PriceSpecification
    {
        ...
        /// </summary>
        [DataMember(Name = "billingIncrement", Order = 404)]
        ...
        /// </summary>
        [DataMember(Name = "priceType", Order = 405)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "referenceQuantity", Order = 406)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "unitCode", Order = 407)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "unitText", Order = 408)]
        [JsonConverter(typeof(ValuesConverter))]
