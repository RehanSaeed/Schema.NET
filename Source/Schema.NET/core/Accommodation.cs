namespace Schema.NET
{
    ...
    public partial class Accommodation : Place
    {
        ...
        /// </summary>
        [DataMember(Name = "amenityFeature", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "floorSize", Order = 205)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "numberOfRooms", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "permittedUsage", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "petsAllowed", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
