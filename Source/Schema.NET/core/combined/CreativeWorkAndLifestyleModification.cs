namespace Schema.NET
{
    ...
    /// </summary>
    public partial interface ICreativeWorkAndLifestyleModification : ILifestyleModification, ICreativeWork
    {
    }
    ...
    /// </summary>
    [DataContract]
    public abstract partial class CreativeWorkAndLifestyleModification : MedicalEntity, ICreativeWorkAndLifestyleModification, IEquatable<CreativeWorkAndLifestyleModification>
    {
        /// <summary>
        ...
        /// <inheritdoc/>
        public bool Equals(CreativeWorkAndLifestyleModification other)
        {
            if (other is null)
            {
                return false;
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => this.Equals(obj as CreativeWorkAndLifestyleModification);
