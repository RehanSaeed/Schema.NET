namespace Schema.NET
{
    ...
    /// </summary>
    [DataContract]
    public abstract partial class LocalBusinessAndPlace : OrganizationAndPlace, ILocalBusinessAndPlace
    {
        /// <summary>
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override OneOrMany<IPlace>? GeospatiallyContains { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override OneOrMany<IPlace>? GeospatiallyCoveredBy { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override OneOrMany<IPlace>? GeospatiallyCovers { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override OneOrMany<IPlace>? GeospatiallyCrosses { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override OneOrMany<IPlace>? GeospatiallyDisjoint { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override OneOrMany<IPlace>? GeospatiallyEquals { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override OneOrMany<IPlace>? GeospatiallyIntersects { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override OneOrMany<IPlace>? GeospatiallyOverlaps { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override OneOrMany<IPlace>? GeospatiallyTouches { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override OneOrMany<IPlace>? GeospatiallyWithin { get; set; }
