namespace Schema.NET
{
    ...
    /// </summary>
    public partial interface ICivicStructureAndOrganization : ICivicStructure, IOrganization
    {
    }
    ...
    /// </summary>
    [DataContract]
    public abstract partial class CivicStructureAndOrganization : Place, ICivicStructureAndOrganization, IEquatable<CivicStructureAndOrganization>
    {
        /// <summary>
        /// Gets the name of the type as specified by schema.org.
        /// </summary>
        [DataMember(Name = "@type", Order = 1)]
        public override string Type => "CivicStructureAndOrganization";
        ...
        /// </summary>
        [DataMember(Name = "department", Order = 215)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "dissolutionDate", Order = 216)]
        ...
        /// </summary>
        [DataMember(Name = "diversityPolicy", Order = 217)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "diversityStaffingReport", Order = 218)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "interactionStatistic", Order = 232)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "publishingPrinciples", Order = 249)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "review", Order = 250)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "seeks", Order = 251)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "slogan", Order = 252)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "sponsor", Order = 253)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "subOrganization", Order = 254)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "taxID", Order = 255)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "telephone", Order = 256)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "unnamedSourcesPolicy", Order = 257)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "vatID", Order = 258)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<string> VatID { get; set; }

        /// <inheritdoc/>
        public bool Equals(CivicStructureAndOrganization other)
        {
            if (other is null)
            {
                return false;
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => this.Equals(obj as CivicStructureAndOrganization);
