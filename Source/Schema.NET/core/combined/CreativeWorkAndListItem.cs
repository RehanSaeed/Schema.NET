namespace Schema.NET
{
    ...
    /// <summary>
    /// See CreativeWork, ListItem for more information.
    /// </summary>
    public partial interface ICreativeWorkAndListItem : IListItem, ICreativeWork
    {
    }
    ...
    /// </summary>
    [DataContract]
    public abstract partial class CreativeWorkAndListItem : Intangible, ICreativeWorkAndListItem, IEquatable<CreativeWorkAndListItem>
    {
        /// <summary>
        /// Gets the name of the type as specified by schema.org.
        /// </summary>
        [DataMember(Name = "@type", Order = 1)]
        public override string Type => "CreativeWorkAndListItem";
        ...
        /// </summary>
        [DataMember(Name = "offers", Order = 274)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "pattern", Order = 275)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "size", Order = 291)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "sourceOrganization", Order = 292)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "spatial", Order = 293)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "spatialCoverage", Order = 294)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "sponsor", Order = 295)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "teaches", Order = 296)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "temporal", Order = 297)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "temporalCoverage", Order = 298)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "text", Order = 299)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "thumbnailUrl", Order = 300)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "timeRequired", Order = 301)]
        ...
        /// </summary>
        [DataMember(Name = "translationOfWork", Order = 302)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "translator", Order = 303)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "typicalAgeRange", Order = 304)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "usageInfo", Order = 305)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "version", Order = 306)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "video", Order = 307)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "workExample", Order = 308)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        ...
        /// </summary>
        [DataMember(Name = "workTranslation", Order = 309)]
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<ICreativeWork> WorkTranslation { get; set; }

        /// <inheritdoc/>
        public bool Equals(CreativeWorkAndListItem other)
        {
            if (other is null)
            {
                return false;
        ...
        /// <inheritdoc/>
        public override bool Equals(object obj) => this.Equals(obj as CreativeWorkAndListItem);
