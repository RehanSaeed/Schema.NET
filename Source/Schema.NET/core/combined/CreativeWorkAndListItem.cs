namespace Schema.NET
{
    ...
    /// </summary>
    [DataContract]
    public abstract partial class CreativeWorkAndListItem : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "spatialCoverage", Order = 282)]
