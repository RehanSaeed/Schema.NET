namespace Schema.NET
{
    ...
    public partial class Recipe : CreativeWork
    {
        ...
        /// </summary>
        [DataMember(Name = "cookingMethod", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "cookTime", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "nutrition", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "prepTime", Order = 207)]
        [JsonConverter(typeof(TimeSpanToISO8601DurationValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "recipeCategory", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "recipeCuisine", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "recipeIngredient", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "recipeInstructions", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "recipeYield", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "suitableForDiet", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "totalTime", Order = 214)]
        [JsonConverter(typeof(TimeSpanToISO8601DurationValuesConverter))]
