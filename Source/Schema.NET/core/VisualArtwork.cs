namespace Schema.NET
{
    ...
    public partial class VisualArtwork : CreativeWork
    {
        ...
        /// </summary>
        [DataMember(Name = "artEdition", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "artform", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "artMedium", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "artworkSurface", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "depth", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "height", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "width", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
