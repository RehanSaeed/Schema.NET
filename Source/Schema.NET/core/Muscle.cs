namespace Schema.NET
{
    ...
    public partial class Muscle : AnatomicalStructure
    {
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public OneOrMany<Muscle>? Antagonist { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public OneOrMany<Vessel>? BloodSupply { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public OneOrMany<AnatomicalStructure>? Insertion { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public OneOrMany<Nerve>? Nerve { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public OneOrMany<AnatomicalStructure>? Origin { get; set; }
    }
}
