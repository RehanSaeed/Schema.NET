namespace Schema.NET
{
    ...
    public partial class ExerciseAction : PlayAction
    {
        ...
        /// </summary>
        [DataMember(Name = "exerciseCourse", Order = 305)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "fromLocation", Order = 306)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "opponent", Order = 307)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "sportsActivityLocation", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "sportsEvent", Order = 309)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "sportsTeam", Order = 310)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "toLocation", Order = 311)]
        [JsonConverter(typeof(ValuesConverter))]
