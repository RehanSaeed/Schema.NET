namespace Schema.NET
{
    ...
    public partial class Offer : Intangible
    {
        ...
        public interface IAddOn : IValue {}
        public interface IAddOn<T> : IAddOn { new T Value { get; } }
        public class OneOrManyAddOn : OneOrMany<IAddOn>
        {
            public OneOrManyAddOn(IAddOn item) : base(item) { }
            public OneOrManyAddOn(IEnumerable<IAddOn> items) : base(items) { }
            public static implicit operator OneOrManyAddOn (Offer value) { return new OneOrManyAddOn (new AddOnOffer (value)); }
            public static implicit operator OneOrManyAddOn (Offer[] values) { return new OneOrManyAddOn (values.Select(v => (IAddOn) new AddOnOffer (v))); }
            public static implicit operator OneOrManyAddOn (List<Offer> values) { return new OneOrManyAddOn (values.Select(v => (IAddOn) new AddOnOffer (v))); }
        }
        public struct AddOnOffer : IAddOn<Offer>
        {
            object IValue.Value => this.Value;
            public Offer Value { get; }
            public AddOnOffer (Offer value) { Value = value; }
            public static implicit operator AddOnOffer (Offer value) { return new AddOnOffer (value); }
        }
        ...
        public interface IOfferedBy : IValue {}
        public interface IOfferedBy<T> : IOfferedBy { new T Value { get; } }
        public class OneOrManyOfferedBy : OneOrMany<IOfferedBy>
        {
            public OneOrManyOfferedBy(IOfferedBy item) : base(item) { }
            public OneOrManyOfferedBy(IEnumerable<IOfferedBy> items) : base(items) { }
            public static implicit operator OneOrManyOfferedBy (Organization value) { return new OneOrManyOfferedBy (new OfferedByOrganization (value)); }
            public static implicit operator OneOrManyOfferedBy (Organization[] values) { return new OneOrManyOfferedBy (values.Select(v => (IOfferedBy) new OfferedByOrganization (v))); }
            public static implicit operator OneOrManyOfferedBy (List<Organization> values) { return new OneOrManyOfferedBy (values.Select(v => (IOfferedBy) new OfferedByOrganization (v))); }
            public static implicit operator OneOrManyOfferedBy (Person value) { return new OneOrManyOfferedBy (new OfferedByPerson (value)); }
            public static implicit operator OneOrManyOfferedBy (Person[] values) { return new OneOrManyOfferedBy (values.Select(v => (IOfferedBy) new OfferedByPerson (v))); }
            public static implicit operator OneOrManyOfferedBy (List<Person> values) { return new OneOrManyOfferedBy (values.Select(v => (IOfferedBy) new OfferedByPerson (v))); }
        }
        public struct OfferedByOrganization : IOfferedBy<Organization>
        {
            object IValue.Value => this.Value;
            public Organization Value { get; }
            public OfferedByOrganization (Organization value) { Value = value; }
            public static implicit operator OfferedByOrganization (Organization value) { return new OfferedByOrganization (value); }
        }
        public struct OfferedByPerson : IOfferedBy<Person>
        {
            object IValue.Value => this.Value;
            public Person Value { get; }
            public OfferedByPerson (Person value) { Value = value; }
            public static implicit operator OfferedByPerson (Person value) { return new OfferedByPerson (value); }
        }
        ...
        public interface IPriceValidUntil : IValue {}
        public interface IPriceValidUntil<T> : IPriceValidUntil { new T Value { get; } }
        public class OneOrManyPriceValidUntil : OneOrMany<IPriceValidUntil>
        {
            public OneOrManyPriceValidUntil(IPriceValidUntil item) : base(item) { }
            public OneOrManyPriceValidUntil(IEnumerable<IPriceValidUntil> items) : base(items) { }
            public static implicit operator OneOrManyPriceValidUntil (DateTimeOffset value) { return new OneOrManyPriceValidUntil (new PriceValidUntilDateTimeOffset (value)); }
            public static implicit operator OneOrManyPriceValidUntil (DateTimeOffset[] values) { return new OneOrManyPriceValidUntil (values.Select(v => (IPriceValidUntil) new PriceValidUntilDateTimeOffset (v))); }
            public static implicit operator OneOrManyPriceValidUntil (List<DateTimeOffset> values) { return new OneOrManyPriceValidUntil (values.Select(v => (IPriceValidUntil) new PriceValidUntilDateTimeOffset (v))); }
        }
        public struct PriceValidUntilDateTimeOffset : IPriceValidUntil<DateTimeOffset>
        {
            object IValue.Value => this.Value;
            public DateTimeOffset Value { get; }
            public PriceValidUntilDateTimeOffset (DateTimeOffset value) { Value = value; }
            public static implicit operator PriceValidUntilDateTimeOffset (DateTimeOffset value) { return new PriceValidUntilDateTimeOffset (value); }
        }
        ...
        public OneOrManyAddOn AddOn { get; set; }
        ...
        public OneOrManyOfferedBy OfferedBy { get; set; }
        ...
        public OneOrManyPriceValidUntil PriceValidUntil { get; set; }
