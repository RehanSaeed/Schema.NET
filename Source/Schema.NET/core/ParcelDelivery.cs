namespace Schema.NET
{
    ...
    public partial interface IParcelDelivery : IIntangible
    {
        ...
        /// Destination address.
        /// </summary>
        OneOrMany<IPostalAddress, PostalAddress> DeliveryAddress { get; set; }

        /// <summary>
        /// New entry added as the package passes through each leg of its journey (from shipment to final delivery).
        /// </summary>
        OneOrMany<IDeliveryEvent, DeliveryEvent> DeliveryStatus { get; set; }
        ...
        /// </summary>
        OneOrMany<IProduct, Product> ItemShipped { get; set; }

        /// <summary>
        /// Shipper's address.
        /// </summary>
        OneOrMany<IPostalAddress, PostalAddress> OriginAddress { get; set; }

        /// <summary>
        /// The overall order the items in this delivery were included in.
        /// </summary>
        OneOrMany<IOrder, Order> PartOfOrder { get; set; }
    ...
    public partial class ParcelDelivery : Intangible, IParcelDelivery
    {
        ...
        public OneOrMany<IPostalAddress, PostalAddress> DeliveryAddress { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IDeliveryEvent, DeliveryEvent> DeliveryStatus { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IProduct, Product> ItemShipped { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IPostalAddress, PostalAddress> OriginAddress { get; set; }
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IOrder, Order> PartOfOrder { get; set; }
