namespace Schema.NET
{
    ...
    public partial class ParcelDelivery : Intangible
    {
        ...
        /// Destination address.
        /// </summary>
        [DataMember(Name = "deliveryAddress", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "deliveryStatus", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "expectedArrivalFrom", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "expectedArrivalUntil", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "itemShipped", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// Shipper's address.
        /// </summary>
        [DataMember(Name = "originAddress", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "partOfOrder", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "provider", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "trackingNumber", Order = 214)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "trackingUrl", Order = 215)]
        [JsonConverter(typeof(ValuesConverter))]
