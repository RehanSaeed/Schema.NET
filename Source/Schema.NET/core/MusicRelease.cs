namespace Schema.NET
{
    ...
    public partial class MusicRelease : MusicPlaylist
    {
        ...
        /// </summary>
        [DataMember(Name = "catalogNumber", Order = 304)]
        ...
        /// </summary>
        [DataMember(Name = "creditedTo", Order = 305)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "musicReleaseFormat", Order = 307)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "recordLabel", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "releaseOf", Order = 309)]
        [JsonConverter(typeof(ValuesConverter))]
