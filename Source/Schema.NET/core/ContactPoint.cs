namespace Schema.NET
{
    ...
    public partial class ContactPoint : StructuredValue
    {
        ...
        /// </summary>
        [DataMember(Name = "areaServed", Order = 305)]
        ...
        /// </summary>
        [DataMember(Name = "availableLanguage", Order = 306)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "contactOption", Order = 307)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "contactType", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// Email address.
        /// </summary>
        [DataMember(Name = "email", Order = 309)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// The fax number.
        /// </summary>
        [DataMember(Name = "faxNumber", Order = 310)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "hoursAvailable", Order = 311)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "productSupported", Order = 312)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "telephone", Order = 313)]
        [JsonConverter(typeof(ValuesConverter))]
