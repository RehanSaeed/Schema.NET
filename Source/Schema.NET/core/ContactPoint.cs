namespace Schema.NET
{
    ...
    public partial class ContactPoint : StructuredValue
    {
        ...
        /// </summary>
        [DataMember(Name = "areaServed", Order = 304)]
        ...
        /// </summary>
        [DataMember(Name = "availableLanguage", Order = 305)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "contactOption", Order = 306)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "contactType", Order = 307)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// Email address.
        /// </summary>
        [DataMember(Name = "email", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// The fax number.
        /// </summary>
        [DataMember(Name = "faxNumber", Order = 309)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "hoursAvailable", Order = 310)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "productSupported", Order = 311)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "telephone", Order = 312)]
        [JsonConverter(typeof(ValuesConverter))]
