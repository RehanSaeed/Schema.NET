namespace Schema.NET
{
    ...
    public partial class Flight : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "aircraft", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "arrivalAirport", Order = 205)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "arrivalGate", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "arrivalTerminal", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "boardingPolicy", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "departureAirport", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "departureGate", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "departureTerminal", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "departureTime", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "estimatedFlightDuration", Order = 214)]
        ...
        /// </summary>
        [DataMember(Name = "flightDistance", Order = 215)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "flightNumber", Order = 216)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "mealService", Order = 217)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "provider", Order = 218)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "seller", Order = 219)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "webCheckinTime", Order = 220)]
        [JsonConverter(typeof(ValuesConverter))]
