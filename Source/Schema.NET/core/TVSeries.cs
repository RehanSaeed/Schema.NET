namespace Schema.NET
{
    ...
    public partial class TVSeries : CreativeWorkSeries
    {
        ...
        /// </summary>
        [DataMember(Name = "containsSeason", Order = 306)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "countryOfOrigin", Order = 307)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "musicBy", Order = 310)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "numberOfEpisodes", Order = 311)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "numberOfSeasons", Order = 312)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "productionCompany", Order = 313)]
        [JsonConverter(typeof(ValuesConverter))]
