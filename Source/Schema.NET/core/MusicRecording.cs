namespace Schema.NET
{
    ...
    public partial class MusicRecording : CreativeWork
    {
        ...
        /// </summary>
        [DataMember(Name = "byArtist", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "duration", Order = 206)]
        ...
        /// </summary>
        [DataMember(Name = "inAlbum", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "inPlaylist", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "isrcCode", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "recordingOf", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
