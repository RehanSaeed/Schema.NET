namespace Schema.NET
{
    ...
    public partial class FoodEstablishment : LocalBusiness
    {
        ...
        /// </summary>
        [DataMember(Name = "acceptsReservations", Order = 304)]
        ...
        /// </summary>
        [DataMember(Name = "hasMenu", Order = 305)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "servesCuisine", Order = 306)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "starRating", Order = 307)]
        [JsonConverter(typeof(ValuesConverter))]
