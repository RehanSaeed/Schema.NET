namespace Schema.NET
{
    ...
    public partial class Invoice : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "accountId", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "billingPeriod", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "category", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "minimumPaymentDue", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentDueDate", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentMethod", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentMethodId", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentStatus", Order = 214)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "provider", Order = 215)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "referencesOrder", Order = 216)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "scheduledPaymentDate", Order = 217)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "totalPaymentDue", Order = 218)]
        [JsonConverter(typeof(ValuesConverter))]
