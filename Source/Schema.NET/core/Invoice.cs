namespace Schema.NET
{
    ...
    public partial class Invoice : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "accountId", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "billingPeriod", Order = 206)]
        ...
        /// </summary>
        [DataMember(Name = "minimumPaymentDue", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentDueDate", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentMethod", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentMethodId", Order = 214)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentStatus", Order = 215)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "provider", Order = 216)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "referencesOrder", Order = 217)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "scheduledPaymentDate", Order = 218)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "totalPaymentDue", Order = 219)]
        [JsonConverter(typeof(ValuesConverter))]
