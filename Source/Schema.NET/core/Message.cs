namespace Schema.NET
{
    ...
    public partial class Message : CreativeWork
    {
        ...
        /// </summary>
        [DataMember(Name = "dateRead", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "dateReceived", Order = 205)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "dateSent", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "messageAttachment", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "recipient", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "sender", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
