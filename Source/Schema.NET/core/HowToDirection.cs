namespace Schema.NET
{
    ...
    /// </summary>
    public partial interface IHowToDirection : IListItem
    {
        /// <summary>
        /// A media object representing the circumstances after performing this direction.
        /// </summary>
        OneOrMany<IMediaObject>? AfterMedia { get; set; }

        /// <summary>
        /// A media object representing the circumstances before performing this direction.
        /// </summary>
        OneOrMany<IMediaObject>? BeforeMedia { get; set; }

        /// <summary>
        /// A media object representing the circumstances while performing this direction.
        /// </summary>
        OneOrMany<IMediaObject>? DuringMedia { get; set; }
    ...
    /// </summary>
    [DataContract]
    public partial class HowToDirection : ListItem, IHowToDirection
    {
        /// <summary>
        ...
        public OneOrMany<IMediaObject>? AfterMedia { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public OneOrMany<IMediaObject>? BeforeMedia { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public OneOrMany<IMediaObject>? DuringMedia { get; set; }
