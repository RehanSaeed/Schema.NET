namespace Schema.NET
{
    ...
    public partial class Thing
    {
        ...
        /// </summary>
        [DataMember(Name = "additionalType", Order = 6)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "alternateName", Order = 7)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "disambiguatingDescription", Order = 8)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "identifier", Order = 9)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "mainEntityOfPage", Order = 11)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "potentialAction", Order = 12)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "sameAs", Order = 13)]
        [JsonConverter(typeof(ValuesConverter))]
