namespace Schema.NET
{
    ...
    public partial class Game : CreativeWork
    {
        ...
        /// </summary>
        [DataMember(Name = "characterAttribute", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "gameItem", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "gameLocation", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "numberOfPlayers", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "quest", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
