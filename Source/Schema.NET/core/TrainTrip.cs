namespace Schema.NET
{
    ...
    public partial class TrainTrip : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "arrivalPlatform", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "arrivalStation", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "departurePlatform", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "departureStation", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "departureTime", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "trainName", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "trainNumber", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
