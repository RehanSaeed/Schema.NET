namespace Schema.NET
{
    ...
    public partial class RadioSeries : CreativeWorkSeries
    {
        ...
        /// </summary>
        [DataMember(Name = "episode", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "numberOfEpisodes", Order = 310)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "numberOfSeasons", Order = 311)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "productionCompany", Order = 312)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "trailer", Order = 313)]
        [JsonConverter(typeof(ValuesConverter))]
