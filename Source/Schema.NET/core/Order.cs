namespace Schema.NET
{
    ...
    public partial class Order : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "acceptedOffer", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "billingAddress", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "confirmationNumber", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "customer", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "discount", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "discountCode", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "discountCurrency", Order = 212)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "isGift", Order = 213)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "orderDate", Order = 214)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "orderDelivery", Order = 215)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// The item ordered.
        /// </summary>
        [DataMember(Name = "orderedItem", Order = 216)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "orderNumber", Order = 217)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "orderStatus", Order = 218)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "partOfInvoice", Order = 219)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentDueDate", Order = 220)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentMethod", Order = 221)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentMethodId", Order = 222)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "paymentUrl", Order = 223)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "seller", Order = 224)]
        [JsonConverter(typeof(ValuesConverter))]
