namespace Schema.NET
{
    ...
    public partial class Action : Thing
    {
        ...
        /// </summary>
        [DataMember(Name = "actionStatus", Order = 104)]
        ...
        /// </summary>
        [DataMember(Name = "agent", Order = 105)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "endTime", Order = 106)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "error", Order = 107)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "instrument", Order = 108)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "location", Order = 109)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "object", Order = 110)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "participant", Order = 111)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "result", Order = 112)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// &lt;p&gt;Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
        /// </summary>
        [DataMember(Name = "startTime", Order = 113)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "target", Order = 114)]
        [JsonConverter(typeof(ValuesConverter))]
