namespace Schema.NET
{
    ...
    public partial class BusTrip : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "arrivalBusStop", Order = 205)]
        ...
        /// </summary>
        [DataMember(Name = "busName", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "busNumber", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "departureBusStop", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
