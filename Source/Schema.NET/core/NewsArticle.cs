namespace Schema.NET
{
    ...
    public partial class NewsArticle : Article
    {
        ...
        /// </summary>
        [DataMember(Name = "dateline", Order = 304)]
        ...
        /// </summary>
        [DataMember(Name = "printColumn", Order = 305)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "printEdition", Order = 306)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "printPage", Order = 307)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "printSection", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
