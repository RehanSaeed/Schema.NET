namespace Schema.NET
{
    ...
    public partial interface IOccupation : IIntangible
    {
        ...
        /// </summary>
        OneOrMany<IAdministrativeArea, AdministrativeArea> OccupationLocation { get; set; }
    ...
    public partial class Occupation : Intangible, IOccupation
    {
        ...
        [JsonConverter(typeof(ValuesJsonConverter))]
        public OneOrMany<IAdministrativeArea, AdministrativeArea> OccupationLocation { get; set; }
