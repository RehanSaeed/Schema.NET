namespace Schema.NET
{
    ...
    public partial class Permit : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "issuedBy", Order = 204)]
        ...
        /// </summary>
        [DataMember(Name = "issuedThrough", Order = 205)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "permitAudience", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "validFor", Order = 207)]
        ...
        /// </summary>
        [DataMember(Name = "validFrom", Order = 208)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "validIn", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "validUntil", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
