namespace Schema.NET
{
    ...
    public partial class Permit : Intangible
    {
        ...
        /// </summary>
        [DataMember(Name = "issuedThrough", Order = 206)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "permitAudience", Order = 207)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "validFor", Order = 208)]
        ...
        /// </summary>
        [DataMember(Name = "validFrom", Order = 209)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "validIn", Order = 210)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "validUntil", Order = 211)]
        [JsonConverter(typeof(ValuesConverter))]
