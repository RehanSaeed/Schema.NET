namespace Schema.NET
{
    ...
    public partial class PostalAddress : ContactPoint
    {
        ...
        /// </summary>
        [DataMember(Name = "addressCountry", Order = 404)]
        ...
        /// </summary>
        [DataMember(Name = "addressLocality", Order = 405)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "addressRegion", Order = 406)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "postalCode", Order = 407)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "postOfficeBoxNumber", Order = 408)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "streetAddress", Order = 409)]
        [JsonConverter(typeof(ValuesConverter))]
