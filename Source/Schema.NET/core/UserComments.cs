namespace Schema.NET
{
    ...
    public partial class UserComments : UserInteraction
    {
        ...
        /// </summary>
        [DataMember(Name = "commentText", Order = 304)]
        ...
        /// </summary>
        [DataMember(Name = "commentTime", Order = 305)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "creator", Order = 306)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "discusses", Order = 307)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "replyToUrl", Order = 308)]
        [JsonConverter(typeof(ValuesConverter))]
