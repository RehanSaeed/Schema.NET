namespace Schema.NET
{
    ...
    public abstract partial class LocalBusinessAndOrganization : OrganizationAndPlace
    {
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override Values<Article, Uri>? DiversityStaffingReport { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override Values<string, Thing, Uri>? KnowsAbout { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override Values<Language, string>? KnowsLanguage { get; set; }
        ...
        [JsonConverter(typeof(ValuesConverter))]
        public override Values<AboutPage, CreativeWork, string, Uri>? OwnershipFundingInfo { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "sponsor", Order = 254)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "subOrganization", Order = 255)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "taxID", Order = 256)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "telephone", Order = 257)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "unnamedSourcesPolicy", Order = 258)]
        [JsonConverter(typeof(ValuesConverter))]
        ...
        /// </summary>
        [DataMember(Name = "vatID", Order = 259)]
        [JsonConverter(typeof(ValuesConverter))]
